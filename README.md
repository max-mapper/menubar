...
Works on Mac OS, Windows and some Linuxes (patches welcome!) - check out [WORKING-PLATFORMS](./WORKING_PLATFORMS.md) to see all the platforms where menubar works well.
